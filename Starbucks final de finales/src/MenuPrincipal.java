...
public class MenuPrincipal {
    ...
    public static void mostrarMenu() {
        ...
        do {
            ...
            System.out.println("3. Merch y Cafe");
            System.out.println("4. Packs y Boxes");
            System.out.println("5. Mostrar carrito");
            System.out.println("6. Realizar proceso de pago");
            System.out.println("7. Salir");
            System.out.println("Selecciona una opción: ");
            opcion = scanner.nextInt();

            switch (opcion) {
                case 1 -> totalCompra += BebidasKengui.mostrarBebidas(detallesCompra);
                case 2 -> totalCompra += AlimentosAldo.mostrarAlimentos(detallesCompra);
                case 3 -> totalCompra += MerchWitmer.mostrarMerch(detallesCompra);
                case 4 -> totalCompra += PacksYBoxesJose.mostrarpacks(detallesCompra);
                case 5 -> Carrito();
                case 6 -> seleccionarMetodoDePago();
                case 7 -> {
                    if (totalCompra > 0) {
    ...
    public static void generarArchivoTxt() {
        try (FileWriter writer = new FileWriter("boleta.txt")) {

            writer.write("⌈‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ BOLETA ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾⌉\n");
            writer.write(String.format("|%-5s %-40s %-10s %-10s%n", "N°", "Descripción", "Cantidad", "Precio"));
            writer.write("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n");

            if (detallesCompra.isEmpty()) {
                writer.write("No has realizado ninguna compra.\n");
            } else {
                int contador = 1;
                double totalpagar = 0;
                for (String detalle : detallesCompra) {
                    ...
                    if (partes.length == 3) {
                        ...
                        double precioTotal = Double.parseDouble(partes[2].replace("Total: S/ ", "").trim());
                        totalpagar += precioTotal;
                        writer.write(String.format("%-5d  %-40s %-10d S/ %.2f%n", contador++, descripcion, cantidad, precioTotal));
                    } else {
                        writer.write("Error en el formato del detalle: " + detalle + "\n");
                    }
                }
                ...
                writer.write("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\n");
                writer.write(String.format("%-20s %-10s%n", "SUBTOTAL:", String.format("S/ %.2f", subtotal)));
                writer.write(String.format("%-20s %-10s%n", "IGV:", String.format("S/ %.2f", igv)));
                writer.write(String.format("%-20s %-10s%n", "TOTAL:", String.format("S/ %.2f", totalCompra)));
                writer.write("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾");
            }
            System.out.println("Boleta generada exitosamente en el archivo 'boleta.txt'.");
            detallesCompra.clear();
            System.exit(0);
        } catch (IOException e) {
            ...
            case 2 -> {
                ...
                while (pago < totalCompra) {
                    ...
                    if (pagoActual <= 0) {
                        if (!entradaInvalida) {
                            if (pagoActual < 0) {
                                System.out.println("No se permiten montos negativos. Intente nuevamente.");
                            } else {
                                System.out.println("El monto no puede ser cero. Intente nuevamente.");
                            }
